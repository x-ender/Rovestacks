...
const PRIVACY_SECTIONS = [
  { id: "scope", title: "1. Introduction & Scope", body: [
    { p: "This Privacy Policy is issued by Rovestacks (\u201cRovestacks,\u201d \u201cthe Company,\u201d \u201cwe,\u201d \u201cour,\u201d or \u201cus\u201d), a technology company incorporated under the Companies and Allied Matters Act and registered with the Corporate Affairs Commission of Nigeria. It describes how we collect, use, disclose, and safeguard information in connection with Rovenet, our classifieds, marketplace, and social-earning mobile application, and any other digital product or service we may operate under the Rovestacks name (each, a \u201cService\u201d)." },
  ...
  { id: "collect", title: "2. Information We Collect", body: [
    ...
    { ul: [
      ...
      "Payment and payout details, such as bank account information and, where applicable, VTU redemption details, supplied when requesting a withdrawal.",
  ...
  { id: "contact-privacy", title: "13. Contact Us", body: [
    { ul: ["Email: privacy@rovestacks.com", "Company: Rovestacks, registered with the Corporate Affairs Commission, Nigeria"] },
  ]},
...
const TERMS_SECTIONS = [
  { id: "intro", title: "1. Introduction & Acceptance", body: [
    { p: "These Terms & Conditions (\u201cTerms\u201d) constitute a binding agreement between you and Rovestacks, a company incorporated under the Corporate Affairs Commission (CAC) of Nigeria, governing your access to and use of Rovenet and any other product or service Rovestacks may operate (each, a \u201cService\u201d). By creating an account or otherwise using a Service, you agree to be bound by these Terms. If you do not agree, you must not access or use the Service." },
  ]},
  ...
  { id: "earnings", title: "10. Earnings and Withdrawals", body: [
    { ul: [
      "Users may accumulate earnings through eligible activities, such as completed social tasks or in-app rewards.",
      "Earnings may be withdrawn as airtime, data, or other VTU products through our VTU partner, currently VTPass.",
      "Earnings may alternatively be withdrawn directly to a linked Nigerian bank account, subject to a minimum withdrawal amount of \u20a620,000 per request.",
      "Withdrawal requests are subject to identity and account verification and may be delayed or declined where Rovestacks reasonably suspects fraud or a violation of these Terms.",
    ]},
  ]},
  ...
  { id: "contact-terms", title: "20. Contact Us", body: [
    { ul: ["Email: legal@rovestacks.com", "Company: Rovestacks, registered with the Corporate Affairs Commission, Nigeria"] },
  ]},
];

const REFUND_SECTIONS = [
  { id: "overview", title: "1. Overview", body: [
    { p: "This Refund Policy explains when payments made on Rovenet are, and are not, eligible for a refund. It forms part of, and should be read together with, our Terms & Conditions." },
  ]},
  ...
  { id: "earnings-refund", title: "6. Earnings and Withdrawals", body: [
    { p: "This Refund Policy governs payments made by sellers and Task Posters to Rovenet. It does not affect a User's ability to withdraw earnings validly credited to their account, which is governed separately by the Earnings and Withdrawals provisions of our Terms & Conditions." },
  ]},
...
export default function App() {
  ...
  const rovenetFeatures = [
    ...
    { icon: Wallet, title: "Earnings & Withdrawals", copy: "Cash out to a Nigerian bank account, subject to a \u20a620,000 minimum, or redeem instantly as airtime and data via VTU." },
  ];
  const whyItems = [
          ...
          <section className="vision" id="vision">
            <div className="wrap vision-grid">
              ...
              <Reveal delay={100}>
                ...
                <p>
                  <Wordmark /> is registered under the Corporate Affairs Commission of Nigeria to develop
                  software, mobile applications, and digital platforms, and to operate and manage online
                  ecosystems more broadly. That mandate is intentionally wide: we exist to build technology
                  for every sphere of everyday life, not to remain a single-product company.
                </p>
                <p>
            ...
            <Reveal delay={100}>
              <div className="product-grid">
                <div className="product-copy">
                  ...
                  <p>List anything from vehicles to fashion for free, get paid for social media tasks, play in-app games, and withdraw earnings to your bank or as VTU.</p>
